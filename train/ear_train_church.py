...
train_data_path = "../data/train_church.json"
path_base = "/path/to/save_path"
save_path = f"{path_base}/church/ft_model_ear_church.pt"
...
for _ in pbar:
    ...
    for i in tqdms:
        ...
        if num_steps in [286, 576]:
            intermediate_save_path = f"{path_base}/ft_model_ear_church_d{_ + 1}_i{num_steps}.pt"
